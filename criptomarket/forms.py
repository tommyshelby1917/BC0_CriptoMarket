...
class CompraForm(FlaskForm):
    ...
    cantidad_compra = DecimalField('Quina cuantitat en €?', validators=[DataRequired(message="Has d'introduir un número."), NumberRange(min=0, max=99999, message='Debe ser un numero entre 0 y 99999')])
